...
public class ModelCaladBolg extends EntityModel<EntityCaladBolg> {
    ...
    public ModelCaladBolg() {
        ...
        this.point.setTextureOffset(0, 0).addBox(-0.5F, -0.5F, -5.0F, 1.0F, 1.0F, 5.0F, 0.0F, false);

        this.blade1 = new ModelRenderer(this);
        this.blade1.setRotationPoint(0.0F, 0.0F, 7.0F);
        this.point.addChild(this.blade1);
        this.blade1.setTextureOffset(0, 6).addBox(-1.5F, -1.5F, -7.0F, 3.0F, 3.0F, 7.0F, 0.0F, false);

        this.blade2 = new ModelRenderer(this);
        this.blade2.setRotationPoint(0.0F, 0.0F, 20.0F);
        this.point.addChild(this.blade2);
        this.blade2.setTextureOffset(0, 16).addBox(-2.5F, -2.5F, -13.0F, 5.0F, 5.0F, 13.0F, 0.0F, false);

        this.guard = new ModelRenderer(this);
        this.guard.setRotationPoint(0.0F, 0.0F, 21.0F);
        this.point.addChild(this.guard);
        this.guard.setTextureOffset(19, 0).addBox(-3.5F, -3.5F, -1.0F, 7.0F, 7.0F, 1.0F, 0.0F, false);

        this.handle = new ModelRenderer(this);
        this.handle.setRotationPoint(0.0F, 0.0F, 24.0F);
        this.point.addChild(this.handle);
        this.handle.setTextureOffset(19, 8).addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
    }

    @Override
    public void setRotationAngles(EntityCaladBolg bolg, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
