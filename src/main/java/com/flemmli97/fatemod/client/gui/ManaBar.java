...
public class ManaBar extends Gui {
	...
	private static final ResourceLocation texturepath = new ResourceLocation(LibReference.MODID + ":textures/gui/mana_bar.png");
	...
	private void renderBar() {
		...
		int manabarwidth = (int)((cap.getMana() / 100F) * 102);
