...
public class CommandGui extends GuiScreen {
	...
	private GuiPlayerButton[] playerButton = new GuiPlayerButton[] {};
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(currentPage!=3)
		{
			...
			this.mc.fontRendererObj.drawString("§4Name:", this.width/2 -90, this.height / 2 - 5, 1);
			this.mc.fontRendererObj.drawString("§4Damage:", this.width/2 -90, this.height / 2 +15, 1);
			this.mc.fontRendererObj.drawString("§4Armor:", this.width/2 -90, this.height / 2 + 35, 1);
			this.mc.fontRendererObj.drawString("§4Nobel Phantasm:", this.width/2 -90, this.height / 2 + 55, 1);
			if(capSync.getServant()!=null)
			{
				this.mc.fontRendererObj.drawString(capSync.getServantName(), this.width/2 -90, this.height / 2 +5, 1);
				this.mc.fontRendererObj.drawString(String.valueOf(capSync.getServantDmg()), this.width/2 -90, this.height / 2 +25, 1);
				this.mc.fontRendererObj.drawString(String.valueOf(capSync.getServantArmor()), this.width/2 -90, this.height / 2 + 45, 1);
				if(capSync.getServant().getSpecialName()!=null)
					this.mc.fontRendererObj.drawString(capSync.getServant().getSpecialName(), this.width/2 -90, this.height / 2 + 65, 1);
			}
		}
		else
		{
	...
	public void initGui() {
		...
		GrailWarPlayerTracker track = GrailWarPlayerTracker.get(this.mc.theWorld);
		if(currentPage == 0)
		{
