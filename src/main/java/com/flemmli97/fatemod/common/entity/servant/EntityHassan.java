...
public class EntityHassan extends EntityServant {
	...
	public EntityHassan(World world) {
		super(world, EnumServantType.ASSASSIN, "Delusional Illusion", new Item[] {ModItems.dagger});
	...
	public void attackWithNP()
	{
		if(this.copies.isEmpty())
		{
			for(int i = 0; i < 5; i++)
			{
				EntityHassanCopy hassan = new EntityHassanCopy(worldObj, this);
				...
				hassan.onInitialSpawn(this.worldObj.getDifficultyForLocation(this.getPosition()), null);
