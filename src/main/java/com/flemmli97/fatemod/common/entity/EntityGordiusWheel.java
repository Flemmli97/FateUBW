...
public class EntityGordiusWheel extends EntityCreature{
	...
	public void onLivingUpdate() {
		...
		if(!this.worldObj.isRemote && this.isCharging() && this.getPassengers().get(0) instanceof EntityIskander)
		{
			List<EntityLivingBase> list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expandXyz(0.5));
	...
	public void updatePassenger(Entity passenger)
    {
        if (this.isPassenger(passenger))
        {
            ...
            passenger.setPosition(this.posX-offSet.xCoord, this.posY + this.getMountedYOffset() + passenger.getYOffset(), this.posZ-offSet.zCoord);
        }
    }
