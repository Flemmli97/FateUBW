...
public class ModBlocks {
    ...
    public static EnumMap<EnumPositionChalk, RegistryObject<BlockChalkLine>> registerChalk(){
        ...
        for(EnumPositionChalk e : EnumPositionChalk.values())
            map.put(e, BLOCKS.register("chalk_line_"+e.getID(), ()->new BlockChalkLine(e, AbstractBlock.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.1f, 100))));
        return map;
    }
}
