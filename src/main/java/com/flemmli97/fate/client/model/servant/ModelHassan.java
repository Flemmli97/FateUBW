...
public class ModelHassan extends ModelServant<EntityHassan> {
    ...
    @Override
    public void setAngles(EntityHassan servant, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
