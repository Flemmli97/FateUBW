...
public class ModelMedusa extends ModelServant<EntityMedusa> {

    public final BlockBenchAnimations anim;

    public ModelMedusa() {
        super();
        this.anim = new BlockBenchAnimations(this, new ResourceLocation(Fate.MODID, "models/entity/animation/medusa.json"));
    }

    @Override
    public void setAngles(EntityMedusa servant, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
