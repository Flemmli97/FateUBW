...
public class ModelSasaki extends ModelServant<EntitySasaki> {

    public final BlockBenchAnimations anim;

    public ModelSasaki() {
        super();
        this.anim = new BlockBenchAnimations(this, new ResourceLocation(Fate.MODID, "models/entity/animation/sasaki.json"));
    }

    @Override
    public void setAngles(EntitySasaki servant, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
