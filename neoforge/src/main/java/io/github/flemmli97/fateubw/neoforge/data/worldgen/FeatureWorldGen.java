...
import io.github.flemmli97.fateubw.neoforge.data.worldgen.features.BiomeModifiersGen;
import io.github.flemmli97.fateubw.neoforge.data.worldgen.features.ConfiguredFeatureGen;
import io.github.flemmli97.fateubw.neoforge.data.worldgen.features.PlacedFeatureGen;
...
public class FeatureWorldGen implements DataProvider {
    ...
    public FeatureWorldGen(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> provider) {
        ...
        this.subProviders.add(this.configuredFeatureGen = new ConfiguredFeatureGen(packOutput, Fate.MODID, provider));
        this.subProviders.add(this.placedFeatureGen = new PlacedFeatureGen(packOutput, Fate.MODID, provider));
        this.subProviders.add(this.biomeModifiersGen = new BiomeModifiersGen(packOutput, Fate.MODID, provider));
    }
