...
public class BlockStatesGen extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        this.simpleBlock(FateBlocks.CHALK.get(), this.models().singleTexture("fateubw:block/" + FateBlocks.CHALK.getID().getPath(), this.mcLoc("block/thin_block"), "texture", Fate.modRes("blocks/" + FateBlocks.CHALK.getID().getPath()))
                .texture("particle", Fate.modRes("blocks/" + FateBlocks.CHALK.getID().getPath())).element().from(0, 0, 0).to(16, 0.5f, 16)
                ...
                .end());
        this.simpleBlock(FateBlocks.ARTIFACT_ORE.get(), this.models().singleTexture(FateBlocks.ARTIFACT_ORE.getID().getPath(), Fate.modRes("block/ore"), "ore", Fate.modRes("blocks/charm_ore")));
        this.simpleBlock(FateBlocks.GEM_ORE.get(), this.models().singleTexture(FateBlocks.GEM_ORE.getID().getPath(), Fate.modRes("block/ore"), "ore", Fate.modRes("blocks/crystal_ore")));
        this.simpleBlock(FateBlocks.DEEP_SLATE_ARTIFACT_ORE.get(), this.models().getBuilder(FateBlocks.DEEP_SLATE_ARTIFACT_ORE.getID().getPath())
                ...
                .texture("ore", Fate.modRes("blocks/charm_ore"))
        ...
        this.simpleBlock(FateBlocks.DEEP_SLATE_GEM_ORE.get(), this.models().getBuilder(FateBlocks.DEEP_SLATE_GEM_ORE.getID().getPath())
                .parent(this.models().getExistingFile(Fate.modRes("block/ore")))
                .texture("ore", Fate.modRes("blocks/crystal_ore"))
                .texture("stone", ResourceLocation.withDefaultNamespace("block/deepslate")));
