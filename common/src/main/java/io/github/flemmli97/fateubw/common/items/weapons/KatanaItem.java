...
public class KatanaItem extends SwordItem implements IExtendedWeapon {

    public KatanaItem(Tier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn) {
