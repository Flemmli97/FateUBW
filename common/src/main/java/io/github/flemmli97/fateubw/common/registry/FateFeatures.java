...
public class FateFeatures {
    ...
    public static void register() {
        charmFeature = BuiltinRegistries.register(BuiltinRegistries.CONFIGURED_FEATURE, new ResourceLocation(Fate.MODID, "charm_ore"),
                new ConfiguredFeature<>(OreFeature.ORE, new OreConfiguration(List.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, FateBlocks.ARTIFACT_ORE.get().defaultBlockState()),
                        OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, FateBlocks.DEEP_SLATE_ARTIFACT_ORE.get().defaultBlockState())), 2)));
        gemFeature = BuiltinRegistries.register(BuiltinRegistries.CONFIGURED_FEATURE, new ResourceLocation(Fate.MODID, "gem_ores"),
                new ConfiguredFeature<>(OreFeature.ORE, new OreConfiguration(List.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, FateBlocks.GEM_ORE.get().defaultBlockState()),
                        OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, FateBlocks.DEEP_SLATE_GEM_ORE.get().defaultBlockState())), 9)));
