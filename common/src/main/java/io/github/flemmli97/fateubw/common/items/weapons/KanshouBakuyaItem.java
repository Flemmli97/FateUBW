...
public class KanshouBakuyaItem extends SwordItem implements IDualWeapon {

    private final Supplier<ItemStack> stack;

    public KanshouBakuyaItem(Tier tier, int i, float f, Properties properties, Supplier<Item> other) {
