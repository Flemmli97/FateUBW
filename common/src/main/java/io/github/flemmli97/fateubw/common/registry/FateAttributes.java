...
public class FateAttributes {
    ...
    public static final RegistryEntrySupplier<Attribute, Attribute> MAGIC_RESISTANCE = ATTRIBUTES.register("magic_resistance", () -> new RangedAttribute("attribute.fateubw.magic_resistance", 0, 0, 1));
    public static final RegistryEntrySupplier<Attribute, Attribute> PROJECTILE_RESISTANCE = ATTRIBUTES.register("projectile_resistance", () -> new RangedAttribute("attribute.fateubw.projectile_resistance", 0, 0, 20));
