...
public class SpawnEggScreen extends Screen {
    ...
    public void render(PoseStack stack, int mouseX, int mouseY, float partialTick) {
        ...
        int xPadding = 16;
        int yOff = 16;
        this.minecraft.font.draw(stack, Component.translatable("fateubw.gui.spawn.master"), this.leftPos + xPadding, this.topPos + yOff, 0xffffff);
        yOff += 16 + 20 + 8;
        this.minecraft.font.draw(stack, Component.translatable("fateubw.gui.spawn.war"), this.leftPos + xPadding, this.topPos + yOff, 0xffffff);
        yOff += 16;
        this.minecraft.font.draw(stack, Component.translatable("fateubw.gui.spawn.war.help"), this.leftPos + xPadding, this.topPos + yOff, 0xffffff);
        int posX = 180;
        int posY = 100;
    ...
    protected void buttons() {
        ...
        yOff += 16 + 20 + 44;
        this.addRenderableWidget(new Button(this.leftPos + this.sizeX / 2 - 50, this.topPos + yOff, 100, 20, Component.translatable("fateubw.gui.save"), b -> {
