...
public class PacketRegistrar {
    ...
    public static int registerClientPackets(ClientPacketRegister register, int id) {
        register.registerMessage(id++, S2CAltarUpdate.ID, S2CAltarUpdate.class, S2CAltarUpdate::write, S2CAltarUpdate::read, S2CAltarUpdate.Handler::handle);
        register.registerMessage(id++, S2CCommandSeals.ID, S2CCommandSeals.class, S2CCommandSeals::write, S2CCommandSeals::read, S2CCommandSeals.Handler::handle);
        register.registerMessage(id++, S2CGrailGui.ID, S2CGrailGui.class, S2CGrailGui::write, S2CGrailGui::read, S2CGrailGui.Handler::handle);
        register.registerMessage(id++, S2CItemInUse.ID, S2CItemInUse.class, S2CItemInUse::write, S2CItemInUse::read, S2CItemInUse.Handler::handle);
        register.registerMessage(id++, S2CMana.ID, S2CMana.class, S2CMana::write, S2CMana::read, S2CMana.Handler::handle);
        register.registerMessage(id++, S2CPlayerCap.ID, S2CPlayerCap.class, S2CPlayerCap::write, S2CPlayerCap::read, S2CPlayerCap.Handler::handle);
        register.registerMessage(id++, S2CServantSync.ID, S2CServantSync.class, S2CServantSync::write, S2CServantSync::read, S2CServantSync.Handler::handle);
        register.registerMessage(id++, S2CTruceData.ID, S2CTruceData.class, S2CTruceData::write, S2CTruceData::read, S2CTruceData.Handler::handle);
        register.registerMessage(id++, S2CWarData.ID, S2CWarData.class, S2CWarData::write, S2CWarData::read, S2CWarData.Handler::handle);
        return id;
    }
