# FateUBW 
[![](http://cf.way2muchnoise.eu/full_271719_CurseForge_%20.svg)![](http://cf.way2muchnoise.eu/versions/271719.svg)](https://www.curseforge.com/minecraft/mc-mods/fate-ubw)   
...
dependencies {    
    ...
    //NeoForge==========    
    implementation("io.github.flemmli97:fateubw:${minecraft_version}-${mod_version}-${mod_loader}")
}
```